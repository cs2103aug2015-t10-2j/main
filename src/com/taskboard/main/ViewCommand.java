...
//			responseForFiltering = checkForDateValidity(dateValidator);
//			
//			if (responseForFiltering.getException() != null) {
//				return responseForFiltering;
//			}
//			
//			filteredEntries = processFilterByDateTime(filteredEntries, dateValidator);
//		}
//		
...
//		filteredEntries = selectiveFilterByCategory.filterByCategory(entries, searchCategory); 
//		
//		return filteredEntries;
//	}
//	
...
//	}
//	
//	private Response checkForDateValidity(DateTimeValidator dateValidator) {
