...
```
###### src\com\taskboard\main\filter\SelectiveFilter.java
``` java
...
```
###### src\com\taskboard\main\filter\SelectiveFilterProcessor.java
``` java
package com.taskboard.main.filter;
...
```
###### src\com\taskboard\main\logic\Logic.java
``` java
...
```
###### src\com\taskboard\main\validator\DateTimeProcessor.java
``` java
...
```
###### src\com\taskboard\main\validator\DateTimeValidator.java
``` java
package com.taskboard.main.validator;
...
```
###### src\com\taskboard\main\validator\IndexProcessor.java
``` java
package com.taskboard.main.validator;
...
```
###### src\com\taskboard\test\LogicIntegrationTest.java
``` java
