# A0129526B
###### D:\Java Projects\TaskBoard\src\com\taskboard\main\userinterface\TransparentPanel.java
``` java
...
```
###### D:\Java Projects\TaskBoard\src\com\taskboard\main\userinterface\TransparentScrollPane.java
``` java
package com.taskboard.main.userinterface;
...
```
###### D:\Java Projects\TaskBoard\src\com\taskboard\main\userinterface\TransparentTextArea.java
``` java
package com.taskboard.main.userinterface;
import java.awt.AlphaComposite;
import java.awt.Graphics;
...
```
###### D:\Java Projects\TaskBoard\src\com\taskboard\main\userinterface\UserInterface.java
``` java
package com.taskboard.main.userinterface;
