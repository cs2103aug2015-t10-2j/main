# A0129526B
###### src\com\taskboard\main\userinterface\TransparentPanel.java
``` java
...
```
###### src\com\taskboard\main\userinterface\TransparentScrollPane.java
``` java
package com.taskboard.main.userinterface;
...
```
###### src\com\taskboard\main\userinterface\TransparentTextArea.java
``` java
package com.taskboard.main.userinterface;
import java.awt.AlphaComposite;
import java.awt.Graphics;
...
```
###### src\com\taskboard\main\userinterface\UserInterface.java
``` java
package com.taskboard.main.userinterface;
